...
public class PetResponse implements Serializable {
    ...
    public PetResponse(Long id, String nome, Integer idade, String raca, Porte porte, String especie, SexoAnimal sexo) {
        this.id = id;
        this.nome = nome;
        this.idade = idade;
        this.raca = raca;
    ...
    public PetResponse(Pet pet) {
        this(pet.getId(), pet.getNome(), pet.getIdade(), pet.getRaca(), pet.getPorte(), pet.getEspecie(), pet.getSexo());
    }
